...
Asks a question, logs it to the console and tells the user if they got
the answer correct or not. If they did get it correct, add 1 to counter.
If the user enters something that is not a string, it will ask the question
again. If the user presses cancel or enters a empty string then it will
break out of the while loop.  */
    if ( NumberOfQuestions === 1 ) {
      var answer1 = prompt( "Question 1: Have I ever worked at Jamba Juice?" );
      console.log( "Question 1: Answer = " + answerKey[0] + " User Answer = " +
       answer1 );
    ...
    if ( NumberOfQuestions === 2 ) {
      ...
      console.log( "Question 2: Answer = " + answerKey[1] + " User Answer = " +
       answer2 );
      if ( answer2.toLowerCase() === "yes" || answer2.toLowerCase() === "y" ) {
         NumberOfQuestions++;
         alert("Unfortunately no, but that would be really cool if I did. 3.1415 is" +
    ...
    if ( NumberOfQuestions === 3 ) {
      var answer3 = prompt( "Is there a video of me falling on my face while" +
      " dunking a basketball on YouTube?" );
      console.log("Question 3: Answer = " + answerKey[2] + " User Answer = " +
       answer3 );
      if ( answer3.toLowerCase() === "yes" || answer3.toLowerCase() === "y" ) {
         NumberOfQuestions++;
         counter++;
         alert( "Correct, if you click on the image below you can watch the" +
         " video. Don't worry I was okay." );
